...
Pet Ghost | All | Uncommon | At the start of each turn, add a Ghost Swipe or Ghost Defend to your hand (chosen randomly).
...
# Cards
Name | Color | Rarity | Type | Cost | Description
--- | --- | --- | --- | --- | ---
...
Toxin Wave | Green | Uncommon | Skill | 2 | Apply 3(4) **Necrotic** **Poison** and -1(-2) **Strength** to ALL enemies. **Exhaust**.
Atom Bomb | Green | Rare | Attack | 4 | Deal 60(80) damage. Apply 3(4) **Poison** to ALL enemies. **Exhaust**.
Poison Darts | Green | Rare | Skill | X | Apply 2 **Necrotic** **Poison** X(+1) times.
