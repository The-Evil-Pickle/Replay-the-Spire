...
public class FromAllSides
	...
	public FromAllSides()
	{
	  super(ID, NAME, "cards/replay/replayBetaAttack.png", COST, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.GREEN, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ALL_ENEMY);
	  this.baseDamage = 3;
