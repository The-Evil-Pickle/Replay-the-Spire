  ...
  public void update()
  {
    ...
    if (effect > 0)
    {
	  ...
	  for (AbstractMonster mm : AbstractDungeon.getMonsters().monsters) {
		  AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(mm, this.p, new PoisonPower(mm, this.p, effect), effect, AbstractGameAction.AttackEffect.POISON));
	  }
