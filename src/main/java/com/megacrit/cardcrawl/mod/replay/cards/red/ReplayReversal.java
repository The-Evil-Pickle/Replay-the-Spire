  ...
  extends CustomCard
{
  ...
  {
    super(ID, NAME, "cards/replay/Reversal.png", COST, DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.RED, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.NONE);
