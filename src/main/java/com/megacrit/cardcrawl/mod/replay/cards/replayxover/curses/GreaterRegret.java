...
public class GreaterRegret extends CustomCard
{
    public static final String ID = "ReplayTheSpireMod:Greater Regret";
    ...
    public GreaterRegret() {
        super(ID, GreaterRegret.NAME, "cards/replay/betaCurse.png", COST, GreaterRegret.DESCRIPTION, CardType.CURSE, CardColor.CURSE, CardRarity.CURSE, CardTarget.NONE);
    ...
    static {
        ...
        NAME = GreaterRegret.cardStrings.NAME;
        DESCRIPTION = GreaterRegret.cardStrings.DESCRIPTION;
    }
}
