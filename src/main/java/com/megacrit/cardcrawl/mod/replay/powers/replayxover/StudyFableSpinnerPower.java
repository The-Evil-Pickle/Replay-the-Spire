...
import com.megacrit.cardcrawl.mod.replay.actions.replayxover.RandomFableSpinnerCardAction;
...
public class StudyFableSpinnerPower extends AbstractPower
{
    ...
    public StudyFableSpinnerPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void atStartOfTurn() {
        this.flash();
        AbstractDungeon.actionManager.addToBottom(new RandomFableSpinnerCardAction(false));
        if (this.amount <= 1) {
