...
public class StudyPondfishPower extends AbstractPower
{
    ...
    public StudyPondfishPower(final AbstractCreature owner, final AbstractCreature source, final int amount, final boolean upgrade) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public void atStartOfTurn() {
        this.flash();
        AbstractDungeon.actionManager.addToBottom(new RandomCardWithTagAction(this.upgrade, downfallen.STUDY_PONDFISH));
        if (this.amount <= 1) {
