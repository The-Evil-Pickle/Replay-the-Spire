...
public class ThiccSelectCard extends AbstractArchetypeCard {
    // == Basic String/Type Declaration ==
    
    public static final String ID = "Replay:ThickDeckSelectCard";
    public static final String IMG = "cards/replay/stack.png";
    ...
    public void archetypeEffect() { // This is the important necessary bit that adds your archetype.
    	ThiccSet coolSilent = new ThiccSet(); // Simply create a new instance of the archetype class you made in step 1.
    }
