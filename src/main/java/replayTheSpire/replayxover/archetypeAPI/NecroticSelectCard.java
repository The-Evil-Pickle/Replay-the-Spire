...
public class NecroticSelectCard extends AbstractArchetypeCard {
    // == Basic String/Type Declaration ==
    
    public static final String ID = "Replay:NecroticArchetypeSelectCard";
    public static final String IMG = "cards/replay/toxinWave.png";
    ...
    public void archetypeEffect() { // This is the important necessary bit that adds your archetype.
        NecroSet coolSilent = new NecroSet(); // Simply create a new instance of the archetype class you made in step 1.
    }
