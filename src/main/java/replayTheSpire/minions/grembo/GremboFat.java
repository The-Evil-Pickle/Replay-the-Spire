...
public class GremboFat extends AbstractFriendlyMonster
{
    ...
    public GremboFat(float rot) {
        super(GremboFat.NAME, GremboFat.ID, 14, -8.0f, 10.0f, 230.0f, 240.0f, "images/monsters/exord/cook.png", -900.0f + 200.0f * (float)Math.cos(rot), -200.0f * (float)Math.sin(rot));
        this.img = null;
    ...
    private void addMoves(){
        this.moves.addMove(new MinionMove(MOVES[0], this, new Texture("images/summons/bubbles/atk_bubble.png"), "Deal " + this.baseDamage + " damage and apply 1 Weak.", () -> {
        ...
        this.moves.addMove(new MinionMove("Eat", this, new Texture("images/summons/bubbles/heal_bubble.png"), this.name + " heals " + this.heal + " HP and gains " + this.strength + " Strength for 1 round.", () -> {
