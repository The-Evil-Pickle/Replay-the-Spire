...
public class GremboTsundere extends AbstractFriendlyMonster
{
    ...
    public GremboTsundere() {
        super(GremboTsundere.NAME, GremboTsundere.ID, 15, -8.0f, 10.0f, 230.0f, 240.0f, "images/monsters/exord/cook.png", -700.0f, 0.0f);
        this.img = null;
    ...
    private void addMoves(){
        this.moves.addMove(new MinionMove(MOVES[1], this, new Texture("images/monsters/atk_bubble.png"), "Deal " + this.baseDamage + " damage.", () -> {
        ...
        this.moves.addMove(new MinionMove(MOVES[0], this, new Texture("images/monsters/atk_bubble.png"),"Gives you " + this.baseBlock + " Block.", () -> {
            AbstractDungeon.actionManager.addToBottom(new GainBlockAction(AbstractDungeon.player, this, this.baseBlock));
        }));
        this.moves.addMove(new MinionMove("Defend", this, new Texture("images/monsters/atk_bubble.png"),"Gain " + this.baseBlock + " Block.", () -> {
