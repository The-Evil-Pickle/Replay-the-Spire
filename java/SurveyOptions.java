...
public class SurveyOptions extends CustomCard
{
    ...
    public SurveyOptions() {
        super("Survey Options", SurveyOptions.NAME, "cards/replay/replayBetaSkill.png", -1, SurveyOptions.DESCRIPTION, CardType.SKILL, CardColor.COLORLESS, CardRarity.RARE, CardTarget.SELF);
