  ...
  extends AbstractCard
{
  ...
  public Strike_Red()
  {
	super("Strike_R", NAME, "red/attack/strike", "red/attack/strike", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.RED, AbstractCard.CardRarity.BASIC, AbstractCard.CardTarget.ENEMY, 0);
    
    this.baseDamage = 6;
	this.timesUpgraded = 0;
  }
  
  public Strike_Red(int upgrades)
  {
    super("Strike_R", NAME, "red/attack/strike", "red/attack/strike", 1, DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.RED, AbstractCard.CardRarity.BASIC, AbstractCard.CardTarget.ENEMY, 0);
  ...
  {
    return new Strike_Red(this.timesUpgraded);
  }
