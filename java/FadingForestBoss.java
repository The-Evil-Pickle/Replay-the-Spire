		...
		switch(c_event) {
			...
			case OPPR_SERPENT: {
				switch(this.c_part) {
					...
					case 1:
						...
						AbstractDungeon.actionManager.addToTop(new MakeTempCardInDrawPileAction(AbstractDungeon.player, AbstractDungeon.player, new Doubt(), 1, true, false));
						AbstractDungeon.actionManager.addToTop(new ForestEventAction());
						this.c_part = 2;
						break;
					default:
			...
			case OPPR_SLIME: {
				switch(this.c_part) {
					...
					case 1:
						this.giveRelicEffect();
						AbstractDungeon.actionManager.addToTop(new MakeTempCardInDrawPileAction(AbstractDungeon.player, AbstractDungeon.player, new Slimed(), 3, true, false));
					default:
						this.imageEventText.clear();
						break;
				}
					...
					case 0:
						switch(p0) {
							...
							case 2:
								...
								this.imageEventText.clearRemainingOptions();
								this.giveRelicEffect();
								AbstractDungeon.actionManager.addToTop(new MakeTempCardInDrawPileAction(AbstractDungeon.player, AbstractDungeon.player, new Regret(), 1, true, false));
								break;
							default:
								this.imageEventText.clear();
								break;
					...
					case 0:
						switch(p0) {
							...
							case 2:
								...
								AbstractCard c = new Burn();
								c.upgrade();
								AbstractDungeon.actionManager.addToTop(new MakeTempCardInDrawPileAction(AbstractDungeon.player, AbstractDungeon.player, c, 1, true, false));
								break;
							default:
								this.imageEventText.clear();
								break;
